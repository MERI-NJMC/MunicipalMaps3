...
$arcgis_rest_point = "http://arcgis5.njmeadowlands.gov/webmaps/rest/services/";
$arcgis_rest_service = "Parcels/NJMC_Parcels_2011/MapServer/";
...
foreach($rest_response_json as $rest_layer => $v){
	...
	$rest_query_owners_url = $arcgis_rest_url_base . $rest_layers["Owners"]["layer_id"] . "/queryRelatedRecords?objectIds=". array_comma_list($owner_objectids_ary)
		."&relationshipId=6&definitionExpression=&returnGeometry=true&maxAllowableOffset=&outSR=&outFields=".	$rest_layers["Owners"]["layer_outfields"]	."&f=json";
